...
public class Device extends CordovaPlugin {
	...
	//return "CID_KEY_TEST";
	TelephonyManager tel = (TelephonyManager)this.cordova.getActivity().getSystemService(Context.TELEPHONY_SERVICE);
...
int lac = cellLocation.getLac() & 0xffff;
	...
	return " NetworkOperator:  " + ((networkOperator != null) ? networkOperator : "") +" SimOperator:   "+ ((simOperator!=null) ? simOperator : "") + " MCC:  "+ mcc +" MNC:   "+mnc + " CID "+ cid + "  LAC  " + lac ;
